...
import 'package:hive_udemy/Model/ogrenci.dart';
...
Future<void> main() async {
  ...
  var encryptionKey =
  base64Url.decode(await secureStorage.read(key: 'key') ?? 'emre');
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    ...
    box.add('emre'); //index 0, key 0 value emre
    box.add('altunbilek'); //index 1, key 1 value altunbilek
    box.add(true);
